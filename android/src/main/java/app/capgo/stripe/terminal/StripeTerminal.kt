package app.capgo.stripe.terminal
...
import app.capgo.stripe.terminal.helper.TerminalMappers
import app.capgo.stripe.terminal.models.Executor
...
class StripeTerminal(
    ...
    fun cancelDiscoverReaders(call: PluginCall) {
        ...
        android.os.Handler(android.os.Looper.getMainLooper()).postDelayed({ resolveOnce() }, 5000)
